...
const Plans = () => {
     ...
     <div
        ...
        >
          ...
          <ContentBox 
            ...
            subtitle={"Conozca las posibilidades de su marca."}
          /></div>
 ...
 {/* PRIMEROS PASOS | Contenedor de planes ------------------------------------------------ */}
 <div
          className="w-100 h-a h-pr-fl-ma p-10px "
...
<ContentBox
      ...
      />
       ...
       <ContentBox
        ...
        note={"Disponibilidad de registro de nombre."}
      ...
      <div className="w-100 h-a h-pr-fl-ma d-i-f">
       <ContentBox
        className="w-70 m-b-10px  p-10px" Style="border-bottom: 1px dotted; border-color: white; "
        text={"• Disponibilidad en redes."}
        note={"Disponibilidad de usuario en redes."}
        noteclassName="ns-c-e p-l-10px"
