    ...
    return ReactDOM.createPortal(
      <div className="modal">
        <div className="modal-content">
          <img src={imageUrl} alt="Imagen"  className="w-100 h-100 centered " Style="object-fit: contain;" />
          <div className="ZoomControls w-300px bg-d-t flexbox d-n">
          <button className="zoom-button c-p h-e" onClick={handleZoomIn}>+</button>
        <button className="zoom-button c-p h-e" onClick={handleZoomOut}>-</button>
        <button className="zoom-button c-p h-e" onClick={handleResetZoom}>Restablecer</button></div>
