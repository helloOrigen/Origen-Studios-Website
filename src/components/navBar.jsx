...
const navBar = () => {
  ...
  return (
   ...
   <Btn className="w-200px h-pr-fr-ma ns-bg-e p-l-20px p-r-20px p-10px  f-w-bo  br-s-solid  br-r-50px" enlace="https://wa.me/message/QEHFJE3NEAVTE1" text="Contacto"></Btn>
   </div>
          </div>
         {/*  <BtnModal></BtnModal> */}
      </div>
