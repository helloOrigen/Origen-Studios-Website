      ...
      >
        <div className="m-w-90 w-60 h-100 h-pr-fl-ma r-h-c b-s-b-b p-20px ">
          ...
          <ContentBox className="w-100 h-a m-b-40px">
            ...
            <br />
            <br />
            Este documento describe los Términos y Condiciones de Uso de nuestra
            web. Cualquier persona o persona jurídica (en adelante, los
            “Usuarios”) que desee acceder y/o usar nuestra web y/o los servicios
            ofrecidos en nuestra web, quedará sujeto a los presentes Términos y
            Condiciones de Uso, junto con todas las demás políticas, condiciones
            ...
            <span Style="font-weight: bold;">
              ...
              LOS SERVICIOS OFRECIDOS POR Origen&zwj;Studios&zwj;
              <sup>&reg;</sup>
            </span>
            .<br />
            <br />
            ...
            momento los presentes Términos y Condiciones de Uso. Por este
            motivo, recomendamos leer periódicamente estos Términos y
            Condiciones de Uso para estar al tanto de los cambios que puedan
            producirse.
            <br />
            <br />
          ...
          <ContentBox className="w-100 h-a m-b-40px">
            ...
            todos los campos obligatorios de los formularios de inscripción
            disponibles en la página principal de nuestra web. En ambos casos,
            será necesario haber aceptado la Política de Privacidad, así como el
            resto de condiciones que puedan aplicar.
            <br />
            <br />
            ...
            limitativo, se comprometen a no destinarlos a:
            <br />
            <br />
            <ol>
              <li>
              ...
              <br />
              <li>
                II. Provocar daños en los sistemas físicos y lógicos de nuestra
                web, de sus proveedores o de terceras personas, introducir o
                difundir en la red virus informáticos o cualesquiera otros
                sistemas físicos o lógicos que sean susceptibles de provocar los
                daños anteriormente mencionados.{" "}
              </li>
              <br />
              <li>
                {" "}
                ...
                adicional a efectos de corroborar la información personal de los
                Usuarios, así como de suspender temporal o definitivamente a
                aquellos Usuarios cuyos datos no hayan podido ser confirmados.
              </li>
              <br />
              <li>
                V. Nuestra empresa no se responsabiliza por cualquier daño,
                perjuicio o pérdida los Usuarios causados por fallos en el
                sistema, en el servidor o en Internet. Tampoco será responsable
                por cualquier virus que pudiera infectar el equipo del Usuario
                como consecuencia del acceso, uso o examen de nuestra web o a
                raíz de cualquier transferencia de datos, archivos, imágenes,
                textos, o audios contenidos en el mismo.{" "}
              </li>
              <br />
              <li>
                VI.{" "}
                ...
                nuestra web. El sistema puede eventualmente no estar disponible
                debido a dificultades técnicas o fallos de Internet, o por
                cualquier otra circunstancia ajena a nosotros; en tales casos se
                procurará restablecerlo con la mayor celeridad posible sin que
                por ello pueda imputársele algún tipo de responsabilidad. No
                seremos responsables por ningún error u omisión contenidos en
                nuestra web.
              </li>
              <br />
              <li>
                {" "}
                VII. En el caso de cualquier pérdida o robo de las claves de
                acceso, uso no autorizado de nuestra web, así como de cualquier
                ...
                su nombre de usuario y su contraseña para poder acceder a las
          ...
          <ContentBox className="w-100 h-a m-b-40px">
            ...
            propiedad intelectual e industrial de nuestra web, así como de los
            ...
            <br />
            <br />
            Cualquier uso no autorizado previamente por nuestra compañía, será
            ...
            única y exclusivamente, para su uso personal y privado.
            <br />
            <br />
            Los Usuarios deberán abstenerse de suprimir, alterar, eludir o
            manipular cualquier dispositivo de protección o sistema de seguridad
            que estuviera instalado en las diferentes páginas de navegación y
            contenidos de nuestra web titularidad y responsabilidad.
            <br />
            <br />
            <i>
              {" "}
              Únicamente se concederá al Cliente licencia de explotación en caso
              ...
              se proporcione en el momento de la formalización del pago.
            </i>
          </ContentBox>
          ...
          <ContentBox className="w-100 h-a m-b-40px">
            ...
            por errores u omisiones en los contenidos, por falta de
            disponibilidad de nuestra web – el cual realizará paradas periódicas
            por mantenimientos técnicos en caso de ser necesarios – así como
            para la subsanación de problemas que puedan generarse por la
            transmisión de virus o programas de software maliciosos o lesivos en
            los contenidos o en la plataforma, a pesar de haber adoptado todas
            las medidas tecnológicas necesarias para evitarlo.
            <br />
            <br />
            Tampoco asume responsabilidad sobre los enlaces a otras páginas web
            que se encuentren en nuestra web, pudiendo dirigir a los Usuarios a
            ...
            titulares. Por ello los Usuarios acceden bajo su exclusiva
            responsabilidad al contenido y en las condiciones de uso que rijan
            en los mismos.
          </ContentBox>
          ...
          />
          <ContentBox className="w-100 h-a m-b-40px">
            Nos reservamos el derecho de efectuar las modificaciones que
            considere oportunas en nuestra web, pudiendo cambiar, suprimir o
            añadir tanto los contenidos y servicios que se presten a través de
            esta como la forma en la que éstos aparezcan presentados o
            localizados en nuestra web.
            <br />
            <br />
            Por esta razón, te rogamos que compruebes de forma regular los
            textos legales incluidos en nuestra web, con el fin de poder tener
            acceso a la versión más reciente de estos. No obstante, cualquier
            cambio que se produzca, en la medida de lo posible, se comunicará a
            los Usuarios
          </ContentBox>
          {/* 5 MODIFICACIONES Y DURACIÓN ------------------------------------------------------------------ 5 MODIFICACIONES Y DURACIÓN  */}
          ...
          <ContentBox className="w-100 h-a m-b-40px">
            ...
            <ol>
              <li>
                ...
                servicios ni contenidos de nuestra web, incluyendo nuestra
                documentación, sin la previa autorización expresa de por parte
                nuestra.{" "}
              </li>
              <br />
              <li>
                No se establecerán deep-links ni enlaces a las imágenes, ni si
                quiera frames con nuestra web sin la previa autorización
                expresa.{" "}
              </li>
              <br />
              <li>
                No se establecerá ninguna manifestación falsa, inexacta o
                incorrecta sobre nuestra web, ni sobre los servicios o
                contenidos de esta. Salvo aquellos signos que formen parte del
                hipervínculo, la página web en la que se establezca no contendrá
              ...
              <li>
                ...
                realice. Ni el conocimiento y aceptación de los servicios o
                contenidos ofrecidos en dicha página web o portal.
              </li>
              <br />
              <li>
                <span Style="font-weight: bold;">
                ...
                disposición del público en la página web o portal desde el cual
                se realice el hipervínculo, ni de las informaciones y
                manifestaciones incluidas en los mismos.{" "}
              </li>
              <br />
            </ol>
            Nuestra web puede poner a disposición de los Usuarios conexiones y
            enlaces a otros sitios web gestionados y controlados por terceros.
            Dichos enlaces tienen como exclusiva función, la de facilitar a los
            usuarios la búsqueda de información, contenidos y servicios en
            Internet, sin que en ningún caso pueda considerarse una sugerencia,
            ...
            los contenidos, servicios, informaciones y manifestaciones
            disponibles en dichos sitios web.
            <br />
            <br />
            Nuestra compañía tampoco asume responsabilidad, ni siquiera de forma
            indirecta o subsidiaria, por los daños y perjuicios de toda clase
            que pudieran derivarse del acceso, mantenimiento, uso, calidad,
          ...
          <ContentBox className="w-100 h-a m-b-40px">
            ...
            propia o de un tercero, a aquellos Usuarios que incumplan los
          ...
          <ContentBox className="w-100 h-a m-b-40px">
            ...
            resultados que espera obtener al contratar los Servicios. Para ello,
            puede ser necesario el cumplimiento de un nuevo formulario con toda
            la información resumida, envió de documentos digitales, e incluso,
            la realización de llamadas telefónicas y videollamadas, con el fin
            de resolver cualquier tipo de dudas o comentarios que puedan surgir.
            <br />
            <br />
            ...
            el fin de que el Cliente seleccione la propuesta final sobre la que
            se desarrollarán los Servicios.
            <br />
            <br />
            ...
            <br />
            <br />
            El proceso de contratación de Servicios finalizará una vez que el
            Cliente abone la cantidad de la propuesta de pago o proforma y se
            ...
            las averías o errores en nuestra web lo antes posible. El Cliente a
            la hora de contratar Servicios de Diseño Gráfico e Ilustración tiene
            que saber que:
            <br />
            <br />
            <ol>
              <li>
                En la propuesta/proforma/factura el precio indicado en los
                diseños gráficos e ilustraciones, solo contemplan las horas
                hombre utilizadas en el proceso de creación del proyecto del
                Cliente.
              </li>
              <br />
              <li>
                Los Servicios prestados son en concepto de entrega de Activos
                para su propia explotación, con documentos como pueden ser
                "registro de marca", "pantones", "cesión de material", "cesión
                de derechos de autor NO exclusiva" y/o "licencias" que estos
                tres últimos solo tendrán valor junto a los documentos del pago
                correspondiente de las facturas.
              </li>
              <br />
              <li>
                ...
                tarifas oportunas para tener en posesión los Activos Originales.
              </li>
            </ol>
            El Cliente a la hora de contratar Servicios Web tiene que saber que:
            <br />
            <br />
            <ol>
              <li>
                En la propuesta/proforma/factura el precio indicado en los
                desarrollos web, solo contempla las horas hombre utilizadas en
                el proceso de creación del proyecto del Cliente.
              </li>
              <br />
              <li>
                ...
                web), a no ser que el Cliente solicite la entrega del material
                para su propia explotación, que en dicho caso se le sumará un
                50% a mayores en concepto de "cesión de material", "cesión de
                derechos de autor NO exclusiva" y/o "licencias" al precio
                indicado en el propuesta/proforma/factura.
              </li>
              <br />
              <li>
                ...
                del material y control de calidad de Clientes centralizados.
              </li>
              <br />
              <li>
                • El Cliente puede solicitar la transferencia del dominio. En
                este caso el Cliente tendrá que solicitar la transferencia por
                medio de una empresa registradora de servicios web y hosting. Si
                también quiere el diseño, programación y base de datos, estará
                sujeto al punto (2º) de esta lista detallada.
              </li>
              <br />
              <li>
                ...
                se le entregará el material al completo en carpetas tales como
                "WEB" y "DDBB" en compresión .zip o .rar que el Cliente deberá
                de instalar por cuenta propia o si lo desea se lo podrá
                presupuestar.
              </li>
              <br />
              <li>
                ...
                entreguen al Cliente. Dichos datos son entregados en perfectas
                condiciones, exactamente igual que como estaban en nuestros
                servidores, por lo tanto con una funcionalidad al 100%.
              </li>
              <br />
              <li>
                Si se desea la "cesión exclusiva" de los derechos de autor para
                ...
                propuesta económica a medida para el Cliente.
              </li>
            </ol>
            El Cliente a la hora de cancelar Servicios Web tiene que saber que:
            <br />
            <br />
            <ol>
              <li>
                El servicio se dará de baja al final del período de renovación.
                Una vez confirmada la supresión del servicio, todos los datos y
                backups asociados se eliminarán definitivamente. Antes de
                confirmar la baja del servicio, al Cliente le corresponde
            ...
            El Cliente a la hora de contratar los Servicios de Imprenta tiene
            que saber que:
            <br />
            <br />
            <ol>
              <li>
                Los servicios prestados y horas utilizadas en concepto diseño
                gráfico no otorgan al Cliente la propiedad del documento del
                diseño y por consiguiente no se le entregara el documento
                original.
              </li>
              <br />
              <li>
                ...
                de sangrado de línea, color en CMYK y con 300 dpi de calidad, si
                no se cumple estas directrices no podremos atender su pedido y
                le será notificado los errores de vuelta para que lo corrija.
              </li>
              <br />
              <li>
                ...
                errores en el diseño ni se puede reclamar la modificación del
                mismo una vez comenzado el proceso de la creación de las
                planchas de impresión.
              </li>
              <br />
              <li>
                El Cliente ha de revisar y estar presente siempre en el momento
                ...
                desperfectos que hayan sido ocasionados por la empresa de
                transporte.
              </li>
              <br />
              <li>
                Si el Cliente necesita un diseño gráfico para tenerlo en su
                propiedad, deberás de solicitarnos una propuesta económica para
                que puedas obtener el valor del diseño que se te entregue.
              </li>
              <br />
            </ol>
            Además,{" "}
            ...
            informar al Cliente de forma individual.
          </ContentBox>
...
{/*  ------------------------------------------------------------------ 16 RENUNCIA, INDEMNIDAD Y RESPONSABILIDADES (<span Style="font-weight: bold;">
              Origen&zwj;Studios&zwj;<sup>&reg;</sup>
            </span>) */}
...
{/* X------------------------------------------------------------------ 20 PROPIEDAD INTELECTUAL Y SUSPENSIÓN   */}
