 ...
 <span className="w-100 h-a p-10px h-pr-fl-ma bg-black-node-o-70 blur ns-br-r-1">  En caso de no tener vacantes, contamos con nuestra lista de oportunidades para que otras empresas puedan saber de ti!</span>
      ...
      <div className="w-100  h-a h-pr-fl-ma b-s-b-b p-50px of-n">
          <CardContainer >
            ...
            <Link className="" to="/jobs" alt="Redacción"><Card titleclassName="m-b-20px ns-c-gray-6 " CardClassName="inactive" title="Redacción" icon={` ${DocumentStack} `}/></Link>
                <Link className="" to="/jobs" alt="ProducciónSonora"><Card titleclassName="m-b-20px ns-c-gray-6 " CardClassName="inactive" title="Prod. Sonora" icon={` ${VolumeHigh} `}/></Link>
                    <Link className="" to="/jobs" alt="Traducción"><Card titleclassName="m-b-20px ns-c-gray-6 " CardClassName="inactive " title="Traducción" icon={` ${Translate} `}/></Link>
          </CardContainer>
          </div>
      </div>
      </div>
