        ...
        <div className="w-100 h-a r-v-b  h-pr-fl-ma">
          ...
          <Link to="/plans" className="h-e">
            <div
              ...
              Style="border-bottom: 1px solid; border-color: white;"
            >
              <Link to="/process"><NavBarBtn className="b w-100 h-100 h-pr-fl-ma p-10px p-t-30px" text={"Procedimientos"}></NavBarBtn>
            </Link></div>
          </Link>
          ...
          <div
              ...
              Style="border-bottom: 1px solid; border-color: white;"
            >
              <Link to="/gallery"><NavBarBtn className="b w-100 h-100 h-pr-fl-ma p-10px p-t-30px" text={"Galería"}></NavBarBtn>
            </Link></div>
        </div>
    </div>
  </div>  </ul>
